import imgHost from '../images/A_saturnPhoto.png'

// база данных: вопросы и ответы
const stages = [
  {
    question: [
      'У вас в гостях оказались ваши друзья, а ваша квартира похожа на апокалипсис. Что же делать?!'
    ],
    answers: [
  ...
  {
    question: [
      'К вам неожиданно пришли гости, а у вас в холодильнике осталась только недопитая бутылка вина и баночка томатной пасты. Что бы вам сделать?'
    ],
    answers: [
  ...
  {
    question: [
      'Ваша тусовка в самом разгаре, но вы очень устали и хотите спать. Что бы сделали в этот момент?'
    ],
    answers: [
  ...
  {
    question: [
      'Наконец-то ваши гости решили, что это был классный вечер, но хорошего всегда понемногу, и решили расходиться. Вы в это время:'
    ],
    answers: [
...
function showResult() {
  ...
  imageResult.innerHTML = `<img src=${imgHost}>`
