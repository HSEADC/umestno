...
*/
var aa=__webpack_require__(976),ca=__webpack_require__(840);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
var react = __webpack_require__(976);
...
var A_Input = /*#__PURE__*/function (_React$Component) {
  _inherits(A_Input, _React$Component);

  var _super = _createSuper(A_Input);

  function A_Input(props) {
    var _this;

    _classCallCheck(this, A_Input);
...
function M_SearchForm_typeof(obj) { "@babel/helpers - typeof"; return M_SearchForm_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, M_SearchForm_typeof(obj); }
...
function M_SearchForm_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function M_SearchForm_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function O_SearchBar_typeof(obj) { "@babel/helpers - typeof"; return O_SearchBar_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, O_SearchBar_typeof(obj); }
...
function O_SearchBar_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function O_SearchBar_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var O_SearchBar = /*#__PURE__*/function (_React$Component) {
  ...
  function O_SearchBar() {
    ...
    O_SearchBar_defineProperty(O_SearchBar_assertThisInitialized(_this), "renderPostSuggestions", function () {
      ...
      var searchInputValue = _this.props.searchInputValue.toLowerCase(); // postTeasers.forEach((teaser) => {
...
;// CONCATENATED MODULE: ./src/search-vanilla-data.js

var token = "pat6hsqOCYJDemATs.644bd3444b2d22d360689ef2d46ea1ef27ffc97ee6960e112fc0f3cc1e9078fc";
airtable_umd_default().configure({
  endpointUrl: "https://api.airtable.com",
  apiKey: token
});
var base = airtable_umd_default().base("appVfxOFqSchAJJK7");
...
;// CONCATENATED MODULE: ./src/components/A_menubutton_default/A_menubutton_default.jsx
function A_menubutton_default_typeof(obj) { "@babel/helpers - typeof"; return A_menubutton_default_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, A_menubutton_default_typeof(obj); }

function A_menubutton_default_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function A_menubutton_default_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function A_menubutton_default_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function A_menubutton_default_createClass(Constructor, protoProps, staticProps) { if (protoProps) A_menubutton_default_defineProperties(Constructor.prototype, protoProps); if (staticProps) A_menubutton_default_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }

function A_menubutton_default_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) A_menubutton_default_setPrototypeOf(subClass, superClass); }

function A_menubutton_default_setPrototypeOf(o, p) { A_menubutton_default_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return A_menubutton_default_setPrototypeOf(o, p); }

function A_menubutton_default_createSuper(Derived) { var hasNativeReflectConstruct = A_menubutton_default_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = A_menubutton_default_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = A_menubutton_default_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return A_menubutton_default_possibleConstructorReturn(this, result); }; }

function A_menubutton_default_possibleConstructorReturn(self, call) { if (call && (A_menubutton_default_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return A_menubutton_default_assertThisInitialized(self); }

function A_menubutton_default_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function A_menubutton_default_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function A_menubutton_default_getPrototypeOf(o) { A_menubutton_default_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return A_menubutton_default_getPrototypeOf(o); }

// import './A_MainMenu.scss'



var A_menubutton_default = /*#__PURE__*/function (_React$Component) {
  A_menubutton_default_inherits(A_menubutton_default, _React$Component);

  var _super = A_menubutton_default_createSuper(A_menubutton_default);

  function A_menubutton_default() {
    A_menubutton_default_classCallCheck(this, A_menubutton_default);

    return _super.apply(this, arguments);
  }

  A_menubutton_default_createClass(A_menubutton_default, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          text = _this$props.text,
          ...
          url = _this$props.url,
          type = _this$props.type;
      var classes = classnames_default()(A_menubutton_default_defineProperty({
...
;// CONCATENATED MODULE: ./src/components/S_NavBar/S_NavBar.jsx
function S_NavBar_typeof(obj) { "@babel/helpers - typeof"; return S_NavBar_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, S_NavBar_typeof(obj); }

function S_NavBar_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function S_NavBar_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function S_NavBar_createClass(Constructor, protoProps, staticProps) { if (protoProps) S_NavBar_defineProperties(Constructor.prototype, protoProps); if (staticProps) S_NavBar_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }

function S_NavBar_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) S_NavBar_setPrototypeOf(subClass, superClass); }

function S_NavBar_setPrototypeOf(o, p) { S_NavBar_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return S_NavBar_setPrototypeOf(o, p); }

function S_NavBar_createSuper(Derived) { var hasNativeReflectConstruct = S_NavBar_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = S_NavBar_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = S_NavBar_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return S_NavBar_possibleConstructorReturn(this, result); }; }

function S_NavBar_possibleConstructorReturn(self, call) { if (call && (S_NavBar_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return S_NavBar_assertThisInitialized(self); }

function S_NavBar_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function S_NavBar_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function S_NavBar_getPrototypeOf(o) { S_NavBar_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return S_NavBar_getPrototypeOf(o); }

function S_NavBar_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var S_NavBar = /*#__PURE__*/function (_React$Component) {
  S_NavBar_inherits(S_NavBar, _React$Component);

  var _super = S_NavBar_createSuper(S_NavBar);

  function S_NavBar(props) {
    var _this;

    S_NavBar_classCallCheck(this, S_NavBar);

    _this = _super.call(this, props);

    S_NavBar_defineProperty(S_NavBar_assertThisInitialized(_this), "getPathFromUrl", function (url) {
      return url.split(addressPart)[0];
    });

    S_NavBar_defineProperty(S_NavBar_assertThisInitialized(_this), "handleSearchInput", function (searchInputValue) {
    ...
    S_NavBar_defineProperty(S_NavBar_assertThisInitialized(_this), "handleSearchSubmit", function () {
  ...
  S_NavBar_createClass(S_NavBar, [{
    ...
    value: function render() {
      ...
      menu.forEach(function (menuItem, i) {
        ...
        menuElements.push( /*#__PURE__*/react.createElement(A_menubutton_default, {
          text: text,
          type: "mainMenuItem",
      ...
      return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
        className: "W_SimpleNavBar"
      }, /*#__PURE__*/react.createElement("a", {
        className: "A_little_logo",
        href: homeURL
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var root = (0,client/* createRoot */.s)(menubar);
  root.render( /*#__PURE__*/react.createElement(S_NavBar, _extends({
