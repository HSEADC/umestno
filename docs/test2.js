...
var stages = [{
  question: ['Где следует разместить почетного гостя во время официального званого обеда?'],
  answers: [{
    text: 'справа от хозяина',
    count: 1
  }, {
  ...
  question: ['Где обычно должен сидеть организатор встречи на деловой встрече?'],
  answers: [{
    text: 'на противоположном конце от главного гостя',
    count: 0
  }, {
    text: 'в центре стола',
    count: 0
  ...
  answers: [{
    text: 'ближе всех к танцполу',
    count: 0
  }, {
    text: 'дальше всех от жениха и невесты',
    count: 0
  }, {
    text: 'за дргуим столом с остальными родственниками',
    count: 0
  }, {
  ...
  question: ['Куда в ресторане следует положить женскую сумочку во время еды?'],
  answers: [{
    text: 'на отдельном крючке, где висит пальто',
    count: 0
  }, {
  ...
  question: ['При посещении театрального представления, где принято сидеть, если вы приходите раньше других?'],
  answers: [{
    text: 'на заднем ряду, чтобы было больше места для ног',
    count: 0
  }, {
    text: 'на своем месте',
    count: 1
